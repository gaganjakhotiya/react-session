...
/***/ function(module, exports, __webpack_require__) {
	...
	var CP = __webpack_require__(166);
	var abc = function (hexCode) { console.log(hexCode); };
	ReactDOM.render(React.createElement(CP, {onChange: abc}), document.querySelector("#content"));
	ReactDOM.render(React.createElement(CP, null), document.querySelector("#content1"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorPicker = (function (_super) {
	    ...
	    ColorPicker.prototype.render = function () {
	        ...
	        return React.createElement("div", null, React.createElement("div", {id: "color-bars"}, React.createElement("p", null, "Red"), React.createElement("input", {type: "range", name: "red", min: "0", max: "255", value: this.state.red, onChange: this.onChange}), React.createElement("strong", null, this.state.red), React.createElement("br", null), React.createElement("p", null, "Green"), React.createElement("input", {type: "range", name: "green", min: "0", max: "255", value: this.state.green, onChange: this.onChange}), React.createElement("strong", null, this.state.green), React.createElement("br", null), React.createElement("p", null, "Blue"), React.createElement("input", {type: "range", name: "blue", min: "0", max: "255", value: this.state.blue, onChange: this.onChange}), React.createElement("strong", null, this.state.blue), React.createElement("br", null)), React.createElement("div", {style: colorBoxStyle}), React.createElement("div", null, bgHexCode));
	    };
	    return ColorPicker;
	}(React.Component));
